    ...
    def wrapper_function(function_to_time):
        def nested_timefunction(*args, **kw):
            ...
            for i in range(number_repeats):
                ...
                elapsedTime = ((1000000 * delta.seconds +
            ...
            if number_repeats < 2:
                ...
                min_time, max_time, avg_time, std_time = get_statistics(
                    recorded_times)

                if environment == 'host':
                    with open('./results-host-python.csv', 'a+') as file:
                        writer = csv.writer(file)
                        fileName = function_to_time.__name__ + \
                            '_' + str(instance)
                        data = [fileName, avg_time,
                                min_time, max_time, std_time]
